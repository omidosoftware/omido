export const faqs = [
  {
    question: "Voor welk type bedrijf bouwen jullie software?",
    answer:
      "Wij werken met MKB-bedrijven, scale-ups en ambitieuze ondernemers die maatwerksoftware, AI-integraties of schaalbare platformen nodig hebben. Of je nu een intern proces wilt automatiseren of een compleet SaaS-product wilt lanceren — wij bouwen het.",
  },
  {
